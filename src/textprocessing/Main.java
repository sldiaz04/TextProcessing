...
public class Main{
    public static void main(String[] args) {
        ...
        */
        FileReader hiloReader = new FileReader(fileNames, fileContents);
        FileReader hiloReader2 = new FileReader(fileNames, fileContents);
        
        // Poniendole nombre a los hilos
        hiloReader.setName("Hilo Reader 1");
        hiloReader2.setName("Hilo Reader 2");
        
        // Arrancando los hilos
        hiloReader.start();
        hiloReader2.start();
        
        FileProcessor hiloProcessor = new FileProcessor(fileContents, wordFrequencies);
        FileProcessor hiloProcessor2 = new FileProcessor(fileContents, wordFrequencies);
        FileProcessor hiloProcessor3 = new FileProcessor(fileContents, wordFrequencies);
        
        // Poniendole nombre a los hilos
        hiloProcessor.setName("Hilo Processor 1");
        hiloProcessor2.setName("Hilo Processor 2");
        hiloProcessor3.setName("Hilo Processor 3");
        
        // Arrancando los hilos
        hiloProcessor.start();
        hiloProcessor2.start();
        hiloProcessor3.start();
        ...
        try {
            ...
            */
            ...
            System.out.println("A ocurrido un error al esperar el hilo");
        }
...
class Tools {
    public static void fileLocator(FileNames fn, String dirname){
        ...
        if ( dir.isDirectory() ) {
            ...
            System.out.println(dir.getAbsolutePath()); // para depurar
        }
    }
